...
/* MayteraOS #331: SBR is float-heavy; excluded in the no-FPU fixed-point
   AAC-LC build (LC_ONLY_DECODER). */
#ifndef LC_ONLY_DECODER
#define SBR_DEC
#endif
//#define SBR_LOW_POWER
/* MayteraOS #331: PS (parametric stereo) excluded in no-FPU LC-only build. */
#ifndef LC_ONLY_DECODER
#define PS_DEC
#endif
